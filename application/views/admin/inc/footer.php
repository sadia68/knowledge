      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright©TRIC-CIRR2019</span>
          </div>
        </div>
      </footer>
  ...
  <script src="<?=base_url()?>asset/admin/vendor/datatables/jquery.dataTables.js"></script>
  <script src="<?=base_url()?>asset/admin/vendor/datatables/dataTables.bootstrap4.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="<?=base_url()?>asset/admin/js/sb-admin.min.js"></script>
...
$(document).ready(function(){
        ...
        $('.search_by_license_area').hide();
        $('.search_by_vin_area').hide();
 
   $(document).on('click', '.search_by_vin', function(){
    $(".search_by_vin_area").show();
      $(".search_by_license_area").hide();

 });

   $(document).on('click', '.search_by_license', function(){
    $(".search_by_license_area").show();
    $(".search_by_vin_area").hide();
